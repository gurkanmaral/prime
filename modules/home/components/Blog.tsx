    ...
    return (
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-sm font-semibold leading-7 text-indigo-400 sm:text-base">Our Blog</h2>
                ...
                <p className="mt-6 text-base leading-8 text-gray-300 sm:text-lg">
                    Stay updated with the latest fitness trends, nutrition tips, and success stories from our community.
                </p>
            </div>
            {renderContent()}
        </div>
